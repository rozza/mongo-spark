...
class ReadConfigSpec extends FlatSpec with Matchers {
  ...
  it should "validate the values" in {
    ...
    an[IllegalArgumentException] should be thrownBy ReadConfig(new SparkConf().set("spark.mongodb.input.collectionName", "coll"))
    an[IllegalArgumentException] should be thrownBy ReadConfig(new SparkConf().set("spark.mongodb.input.databaseName", "db"))
  ...
  val sparkConf = new SparkConf()
    .set("spark.mongodb.input.databaseName", "db")
    .set("spark.mongodb.input.collectionName", "collection")
