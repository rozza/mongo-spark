...
package com.mongodb.spark.api.java.sql.fields;

import org.bson.types.ObjectId;

import static com.mongodb.spark.api.java.sql.fields.Assertions.notNull;
...
public final class DbPointer {
    ...
    public DbPointer(final String ref, final ObjectId oid) {
        this(ref, notNull("oid", oid).toHexString());
    }
